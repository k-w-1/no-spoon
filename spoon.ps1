# According to OP, the only publicly posted version of this is available at https://www.reddit.com/r/PowerShell/comments/rlkacf/powershell_matrix_simulator/
